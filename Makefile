...
DEFINES   += COIN_P2CS_VERSION=8
DEFINES   += COIN_P2CS2_VERSION=32
...
DEFINES   += COIN_KIND=COIN_KIND_NAVCOIN_TESTNET
APPNAME = "Navcoin Test"
...
DEFINES   += COIN_P2CS_VERSION=21
DEFINES   += COIN_P2CS2_VERSION=36
DEFINES   += COIN_P2SH_VERSION=85
DEFINES   += COIN_COINID=\"Navcoin\"
DEFINES   += COIN_COINID_HEADER=\"NAVCOIN\"
DEFINES   += COIN_COINID_NAME=\"Navcoin\"
DEFINES   += COIN_COINID_SHORT=\"NAV\"
DEFINES   += COIN_KIND=COIN_KIND_NAVCOIN
APPNAME = "Navcoin"

else
ifeq ($(filter clean,$(MAKECMDGOALS)),)
$(error Unsupported COIN - use navcoin_testnet, navcoin)
endif
endif
...
listvariants:
	@echo VARIANTS COIN navcoin_testnet navcoin
